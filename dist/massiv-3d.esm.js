...
class TestRenderer {
    ...
    render(world) {
        ...
        const directionalLights = world.entities.map(entity => {
            const light = world.components.find(component => component instanceof DirectionalLight && component.entityId === entity.id);
            return light;
        }).filter(Boolean);
...
export { Component, DirectionalLight, Entity, Geometry, Mat3, Mat4, Mesh, Node, OrthographicCamera, PerspectiveCamera, Quat, Scene, StandardMaterial, TestRenderer, Transform3D, Vec2, Vec3, Vec4, WebGl2Renderer as WebGL2Renderer, World };
