...
class BoundingBox {
    ...
    constructor(...args) {
        if (args[0] && typeof args[0].byteLength === 'number') {
            ...
            glMatrix.vec3.copy(this.worldPosition.min, args[0].min);
            glMatrix.vec3.copy(this.worldPosition.center, args[0].center);
            glMatrix.vec3.copy(this.worldPosition.max, args[0].max);
        }
    }
    ...
    updateWorldPosition(transform) {
        glMatrix.vec3.copy(this.worldPosition.min, this.data.min);
        glMatrix.vec3.copy(this.worldPosition.center, this.data.center);
        glMatrix.vec3.copy(this.worldPosition.max, this.data.max);
        glMatrix.vec3.transformMat4(this.worldPosition.min, this.worldPosition.min, transform.data.modelMatrix);
        glMatrix.vec3.transformMat4(this.worldPosition.center, this.worldPosition.center, transform.data.modelMatrix);
        glMatrix.vec3.transformMat4(this.worldPosition.max, this.worldPosition.max, transform.data.modelMatrix);
    }
    getWorldPosition() {
