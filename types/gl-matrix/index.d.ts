declare module 'gl-matrix' {
    ...
    export namespace glMatrix {
         ...
         */
        export function setMatrixArrayType(type: unknown): void;
        /**
    ...
    export namespace mat4 {
         ...
         * @returns {mat4} out
         */
        export function perspectiveFromFieldOfView(out: mat4, fov: number, near: number, far: number): mat4;
        /**
    ...
    export namespace quat {
         ...
         */
        export function getAxisAngle(outAxis: vec3, q: quat): number;
        /**
